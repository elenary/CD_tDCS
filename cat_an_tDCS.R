...
# ---------  post hoc interaction Type:Choice (it's significant)-----------
...
#----------------t tests for difference in difficult rejected--------
...
#--------------------------------------CATHODAL REP MEASURMENT ANOVA by different choice factor-------------------------------------------
